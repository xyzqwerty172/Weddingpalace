...
export default function ArrangementView1(params) {
  const length = 5;
    ...
    <MainLayout>
      ...
      <Container>
        <Stack spacing={2} my={2}>
          ...
          <Typography>
            Амьдралынхаа урт замыг эгнэгт хамт туулахаар шийдэн, Эцгийн
            голомтоос галаа таслан бадрааж, өрх үүсгэсэн халуун хайрын эзэн
            залуу хосын хурим.
          </Typography>
          ...
          {Array.from({ length }, (_, i) => (
            <ResponsiveServiceImage
              key={`image-${i}`}
              src={`/assets/images/services/arrangement/1/${i + 1}.png`}
              alt={`Залуу хосын хурим ${i + 1}`}
              mobileRatio="4/3"
            />
          ))}
