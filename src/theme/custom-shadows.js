...
export function customShadows(mode) {
  ...
  return {
    ...
    //
    card: `0 0 2px 0 ${alpha(color, 0.04)}, 0 8px 16px 0 ${alpha(color, 0.04)}`, // 8px soft shadow rgba(0,0,0,.04)
    dropdown: `0 0 2px 0 ${alpha(color, 0.24)}, -20px 20px 40px -4px ${alpha(color, 0.24)}`,
    dialog: `-40px 40px 80px -8px ${alpha(common.black, 0.24)}`,
    //
    // Navigation bar shadow: 4px bottom shadow with primary color
    navigation: `0 2px 20px rgba(0, 175, 154, 0.12)`, // Updated to match #00AF9A
    //
